...
--
-- Host: 127.0.0.1
-- Generation Time: May 04, 2020 at 05:15 PM
...
(337, 796547, 107, 155, 0.66666666666667, 50, 0);
...
(797, 'tom', '2016-10-09', 75),
(798, 'reeshal', '2019-04-17', 75);
...
(796547, 'TEXAS CHAMPION', '0000-00-00', 0, 4),
(796548, 'helloworld', '2020-05-06', 2400, 2);
...
(796547, 107, 795, 0.66666666666667),
(796547, 108, 798, 1.11111111111111),
(796547, 111, 797, 1.11111111111111),
(796547, 114, 796, 1.11111111111111),
(796548, 108, 796, 1),
(796548, 112, 798, 1);
...
--
-- Stand-in structure for view `vw_create_result`
-- (See below for the actual view)
--
CREATE TABLE `vw_create_result` (
`horse_id` int(11)
,`horse_name` varchar(15)
,`jockey_id` int(11)
...
--
DROP TABLE IF EXISTS `vw_create_result`;
...
--
ALTER TABLE `bets`
  MODIFY `bet_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=339;
...
--
ALTER TABLE `jockey`
  MODIFY `jockey_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=799;
...
--
ALTER TABLE `race`
  MODIFY `race_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=796549;
