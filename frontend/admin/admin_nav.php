        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="../../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php echo $_SESSION['user_name'];?></b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                    <li style="padding: 70px 0 0;">
                        <a href="admindashboard.php" class="waves-effect"><i class="fa fa-clock-o fa-fw" aria-hidden="true"></i>Dashboard</a>
                    </li>
                    <li>
