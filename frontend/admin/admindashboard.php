            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <a href="https://www.google.com" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">Upgrade to Pro</a>
                        <ol class="breadcrumb">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        ...
                        <div class="add_race"><a href="#" class="fa fa-plus-square"></a></div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                        <div class="add_horse"><a href="#" class="fa fa-plus-square"></a></div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                        <div class="add_user"><a href="#" class="fa fa-plus-square"></a></div>
