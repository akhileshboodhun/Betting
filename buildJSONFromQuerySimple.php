<?php
	...
	/*$sQuery = "SELECT owner.owner_name, owner.owner_id, owner.owner_email, owner.owner_phone FROM owner ";
	
	if(isset($_GET['owner_id']) && is_numeric($_GET['owner_id']))
	{
		$owner_id = $_GET['owner_id'];
		$sQuery = $sQuery . " WHERE owner.owner_id= $owner_id";
	}
    ...
    $row_stmt = $stmt->fetchAll(PDO::FETCH_ASSOC);
  	...
  	$data1 = json_decode($data);
   	...
   	$schema = Schema::fromJsonString(file_get_contents('JSONSchema_Simple.json'));
